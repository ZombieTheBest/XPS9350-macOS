...
function _install_voodoops2daemon()
{
    ...
    _tidy_exec "sudo cp "${gVoodooPS2Config}" "${to_Plist}"" "Install configuration of VoodooPS2Daemon"
}
...
#sed -ig 's/ECDV/EC/' /DSDT/raw/DSDT.dsl
    ...
    then
        ...
        _tidy_exec "sudo rm -f ${gInstall_Repo}/VoodooPS2Daemon ${to_Plist}/${gVoodooPS2Config#/tmp/}" "Remove VoodooPS2Daemon"
    fi
